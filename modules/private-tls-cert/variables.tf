# ---------------------------------------------------------------------------------------------------------------------
# REQUIRED PARAMETERS
# You must provide a default for each of these parameters.
# ---------------------------------------------------------------------------------------------------------------------
...
variable "ca_public_key_file_path" {
  ...
  default = "/mnt/c/Users/deepa/source/repos/terraform-aws-vault/examples/vault-consul-ami/tls/ca.crt.pem"
}

variable "public_key_file_path" {
  description = "Write the PEM-encoded certificate public key to this path (e.g. /etc/tls/vault.crt.pem)."
  default="/mnt/c/Users/deepa/source/repos/terraform-aws-vault/examples/vault-consul-ami/tls/vault.crt.pem"
}

variable "private_key_file_path" {
  description = "Write the PEM-encoded certificate private key to this path (e.g. /etc/tls/vault.key.pem)."
  default="/mnt/c/Users/deepa/source/repos/terraform-aws-vault/examples/vault-consul-ami/tls/vault.key.pem"
}
